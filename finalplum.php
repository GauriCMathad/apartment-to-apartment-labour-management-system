...
<head>
    ...
    <link rel="stylesheet" href="finalplum.css">
    ...
    <nav class="navbar">
        ...
        <ul class="menu">
            ...
            <li><a href="">Add a member</a></li><?php } ?>
                <?php if($id>90000) { ?>
            <li> <a href="finalmea.php?id=<?php echo $id;?>">Meadows Services</a> </li>
            <li> <a href="resd-profile.php?id=<?php echo $id;?>">Manage Profile</a> </li>
            <li> <a href="logout.php">Logout</a> </li>
            <?php } ?>
            <?php if($id<90000 || $id==6) { ?>
            <li> <a href="finalmea.php?id=<?php echo $id;?>">Back To Meadows</a></li>
            <?php } ?>
        ...
        <div class="slider">
            <figure>
                ...
                <div class="slide">
                    ...
                    <img src="reviews/report/plum1.jpg" alt="">
                </div>
                <div class="slide">
