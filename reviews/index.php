...
<head>
    ...
    <title>Reviews</title>
    <link rel='stylesheet' type="text/css" media="screen" href='rev.css'>
    ...
    ?>
                ...
                echo '<img src="data:image;base64,'.base64_encode($row['pic']).'" style=" border-radius: 30%;">';?>
                    ...
                    ?>
                        ...
                        <div><?php echo $row['year']; ?> years of Experience</div><br>
                        <div class="place-review"><?php echo $row['service']; ?> </div><br>
                        <div style="font-size: 25px;">Rs.<?php echo $row['price']; ?> per hour /-</div>
                        <div class="rating" style="overflow: visible"><?php
                            for($x=0;$x<$row['begin'];$x++) { ?>
